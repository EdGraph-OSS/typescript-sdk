...
**validation** | [**FormApiFormsV1CreateFullQuestionValidationRequest**](FormApiFormsV1CreateFullQuestionValidationRequest.md) |  | [optional] [default to undefined]
...
**originalQuestionId** | **string** |  | [optional] [default to undefined]
**multiline** | **boolean** |  | [optional] [default to undefined]

## Example

```typescript
import { FormApiFormsV1CreateFullQuestionRequest } from '@edgraph-oss/platform-client';

const instance: FormApiFormsV1CreateFullQuestionRequest = {
    title,
    description,
    type,
    required,
