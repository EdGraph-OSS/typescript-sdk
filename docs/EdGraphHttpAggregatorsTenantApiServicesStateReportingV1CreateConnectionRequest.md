...
```typescript
import { EdGraphHttpAggregatorsTenantApiServicesStateReportingV1CreateConnectionRequest } from '@edgraph-oss/platform-client';

const instance: EdGraphHttpAggregatorsTenantApiServicesStateReportingV1CreateConnectionRequest = {
    type,
    tenantId,
    environmentId,
    server,
