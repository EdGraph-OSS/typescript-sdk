...
```typescript
import { EdGraphServicesStateReportingV1SubmissionCancelledResponse } from '@edgraph-oss/platform-client';

const instance: EdGraphServicesStateReportingV1SubmissionCancelledResponse = {
    tenantId,
    environmentId,
    reportingPeriodId,
    submissionId,
