...
```typescript
import { EdGraphHttpAggregatorsTenantApiServicesStateReportingV1UpdateConnectionRequest } from '@edgraph-oss/platform-client';

const instance: EdGraphHttpAggregatorsTenantApiServicesStateReportingV1UpdateConnectionRequest = {
    id,
    tenantId,
    environmentId,
    server,
