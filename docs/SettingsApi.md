...
|------------- | ------------- | -------------|
|[**getTenantSettingByCode**](#gettenantsettingbycode) | **GET** /tenants/{tenantId}/tenantsettings/{code} | Retrieves a Tenant\&#39;s settings by code.|
...
> TenantApiTenantV1TenantSetting getTenantSettingByCode()
...
const { status, data } = await apiInstance.getTenantSettingByCode(
    tenantId,
    code
);
```
...
const { status, data } = await apiInstance.getTenantSettings(
    tenantId,
    pageIndex,
    pageSize,
    orderBy,
...
> TenantApiTenantV1TenantAppSettings getTenantSettingsByCode()
...
const { status, data } = await apiInstance.getTenantSettingsByCode(
    tenantId,
    code
);
```
...
# **setTenantSettings**
> TenantApiTenantV1SetAppSettingsResponse setTenantSettings()
...
const { status, data } = await apiInstance.setTenantSettings(
    tenantId,
    code,
    tenantApiTenantV1SetAppSettingsRequest
);
