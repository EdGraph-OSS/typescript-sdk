...
**educationServiceCenterId** | **number** |  | [optional] [default to undefined]
...
```typescript
import { EdfiAdminApiEdfiAdminV1EducationServiceCenter } from '@edgraph-oss/platform-client';

const instance: EdfiAdminApiEdfiAdminV1EducationServiceCenter = {
    id,
