...
```typescript
import { EdfiAdminApiEdfiAdminV1InstanceApiClientUpdatedResponse } from '@edgraph-oss/platform-client';

const instance: EdfiAdminApiEdfiAdminV1InstanceApiClientUpdatedResponse = {
    tenantId,
    instanceId,
