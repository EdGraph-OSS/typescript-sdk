...
|[**getFullFormSchema**](#getfullformschema) | **GET** /tenants/{tenantId}/forms/{formId}/full/schemas | Get a Forms Json and UI React JSON compatible Schema.|
...
# **getFullFormSchema**
> FormApiFormsV1FullFormSchemaResponse getFullFormSchema()
...
const { status, data } = await apiInstance.getFullFormSchema(
    tenantId,
    formId
);
```
