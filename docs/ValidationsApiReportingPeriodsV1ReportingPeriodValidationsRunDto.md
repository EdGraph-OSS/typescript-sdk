...
```typescript
import { ValidationsApiReportingPeriodsV1ReportingPeriodValidationsRunDto } from '@edgraph-oss/platform-client';

const instance: ValidationsApiReportingPeriodsV1ReportingPeriodValidationsRunDto = {
    requestedAt,
    jobExecutionId,
    jobId,
    status,
