...
**connection** | [**IMSAdminApiV1ConnectionsConnectionProfileResponse**](IMSAdminApiV1ConnectionsConnectionProfileResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { IMSAdminApiV1InstancesInstanceProfileResponse } from '@edgraph-oss/platform-client';

const instance: IMSAdminApiV1InstancesInstanceProfileResponse = {
    instanceId,
    createdBy,
    createdDateTime,
    lastModifiedBy,
