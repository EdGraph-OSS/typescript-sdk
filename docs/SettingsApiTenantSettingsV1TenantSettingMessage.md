...
**schemaVersion** | **string** |  | [optional] [default to undefined]
**value** | [**GoogleProtobufWellKnownTypesValue**](GoogleProtobufWellKnownTypesValue.md) |  | [optional] [default to undefined]
...
```typescript
import { SettingsApiTenantSettingsV1TenantSettingMessage } from '@edgraph-oss/platform-client';

const instance: SettingsApiTenantSettingsV1TenantSettingMessage = {
    id,
    settingTypeId,
    applicationId,
    schemaVersion,
