...
```typescript
import { EdGraphHttpAggregatorsTenantApiServicesStateReportingV1TestConnectionByTypeRequest } from '@edgraph-oss/platform-client';

const instance: EdGraphHttpAggregatorsTenantApiServicesStateReportingV1TestConnectionByTypeRequest = {
    id,
    type,
    tenantId,
    environmentId,
