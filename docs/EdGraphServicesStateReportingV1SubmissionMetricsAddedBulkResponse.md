...
```typescript
import { EdGraphServicesStateReportingV1SubmissionMetricsAddedBulkResponse } from '@edgraph-oss/platform-client';

const instance: EdGraphServicesStateReportingV1SubmissionMetricsAddedBulkResponse = {
    tenantId,
    environmentId,
    reportingPeriodId,
    submissionId,
