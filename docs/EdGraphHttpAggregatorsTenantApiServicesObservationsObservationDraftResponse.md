...
```typescript
import { EdGraphHttpAggregatorsTenantApiServicesObservationsObservationDraftResponse } from '@edgraph-oss/platform-client';

const instance: EdGraphHttpAggregatorsTenantApiServicesObservationsObservationDraftResponse = {
    id,
    formId,
    tenantId,
    data,
