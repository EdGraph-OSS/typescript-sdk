...
```typescript
import { AnalyticsApiConfigurationsV1AnalyticsConfiguration } from '@edgraph-oss/platform-client';

const instance: AnalyticsApiConfigurationsV1AnalyticsConfiguration = {
    id,
    tenantId,
    sqlConnectionString,
    status,
