...
```typescript
import { EdFiAdminApiApplicationAccessV1CreateApplicationAccessRequest } from '@edgraph-oss/platform-client';

const instance: EdFiAdminApiApplicationAccessV1CreateApplicationAccessRequest = {
    tenantId,
    applicationId,
    apiClientId,
    users,
