...
|[**getClientSettingsByCodeAsync**](#getclientsettingsbycodeasync) | **GET** /tenants/{tenantId}/clients/{clientId}/settings/{code} | Retrieves a Tenant\&#39;s ClientSetting by code.|
...
|[**setClientSettingsByCodeAsync**](#setclientsettingsbycodeasync) | **POST** /tenants/{tenantId}/clients/{clientId}/settings/{code} | Creates/updates a Tenant\&#39;s ClientSetting by code.|
...
> TenantApiTenantV1TenantAppSettings getClientSettingsByCodeAsync()
...
const { status, data } = await apiInstance.getClientSettingsByCodeAsync(
    tenantId,
    clientId,
    code
);
...
> TenantApiTenantV1SetAppSettingsResponse setClientSettingsByCodeAsync()
...
const { status, data } = await apiInstance.setClientSettingsByCodeAsync(
    tenantId,
    clientId,
    code,
    tenantApiTenantV1SetAppSettingsRequest
