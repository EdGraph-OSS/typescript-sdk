...
**connectionString** | **string** |  | [optional] [default to undefined]
...
```typescript
import { ValidationsApiDbEnvironmentsV1DbEnvironmentDto } from '@edgraph-oss/platform-client';

const instance: ValidationsApiDbEnvironmentsV1DbEnvironmentDto = {
    tenantId,
    id,
    name,
    connectionType,
