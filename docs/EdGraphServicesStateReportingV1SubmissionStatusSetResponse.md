...
```typescript
import { EdGraphServicesStateReportingV1SubmissionStatusSetResponse } from '@edgraph-oss/platform-client';

const instance: EdGraphServicesStateReportingV1SubmissionStatusSetResponse = {
    tenantId,
    environmentId,
    reportingPeriodId,
    submissionId,
