...
```typescript
import { EdfiAdminApiEdfiAdminV1UpdateInstanceApplicationRequest } from '@edgraph-oss/platform-client';

const instance: EdfiAdminApiEdfiAdminV1UpdateInstanceApplicationRequest = {
    tenantId,
    instanceId,
