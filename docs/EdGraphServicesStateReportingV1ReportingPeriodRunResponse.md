...
```typescript
import { EdGraphServicesStateReportingV1ReportingPeriodRunResponse } from '@edgraph-oss/platform-client';

const instance: EdGraphServicesStateReportingV1ReportingPeriodRunResponse = {
    tenantId,
    environmentId,
    reportingPeriodId,
    ruleIds,
