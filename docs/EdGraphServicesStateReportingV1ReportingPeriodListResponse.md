...
```typescript
import { EdGraphServicesStateReportingV1ReportingPeriodListResponse } from '@edgraph-oss/platform-client';

const instance: EdGraphServicesStateReportingV1ReportingPeriodListResponse = {
    id,
    createdBy,
    createdDateTime,
    lastModifiedBy,
