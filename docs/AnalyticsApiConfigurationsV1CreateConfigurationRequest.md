...
```typescript
import { AnalyticsApiConfigurationsV1CreateConfigurationRequest } from '@edgraph-oss/platform-client';

const instance: AnalyticsApiConfigurationsV1CreateConfigurationRequest = {
    id,
    tenantId,
    sqlConnectionString,
    status,
