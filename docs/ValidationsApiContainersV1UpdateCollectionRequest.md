...
```typescript
import { ValidationsApiContainersV1UpdateCollectionRequest } from '@edgraph-oss/platform-client';

const instance: ValidationsApiContainersV1UpdateCollectionRequest = {
    tenantId,
    id,
    name,
    description,
