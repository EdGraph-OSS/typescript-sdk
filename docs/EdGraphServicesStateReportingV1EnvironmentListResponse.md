...
```typescript
import { EdGraphServicesStateReportingV1EnvironmentListResponse } from '@edgraph-oss/platform-client';

const instance: EdGraphServicesStateReportingV1EnvironmentListResponse = {
    id,
    createdBy,
    createdDateTime,
    lastModifiedBy,
