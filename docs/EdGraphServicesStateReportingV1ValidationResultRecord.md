...
**dbEnvironmentId** | **string** |  | [optional] [default to undefined]
...
**excludeFromPost** | **boolean** |  | [optional] [default to undefined]
**details** | **string** |  | [optional] [default to undefined]
**detailsSchema** | **string** |  | [optional] [default to undefined]

## Example

```typescript
import { EdGraphServicesStateReportingV1ValidationResultRecord } from '@edgraph-oss/platform-client';

const instance: EdGraphServicesStateReportingV1ValidationResultRecord = {
    id,
    tenantId,
    dbEnvironmentId,
    collectionId,
