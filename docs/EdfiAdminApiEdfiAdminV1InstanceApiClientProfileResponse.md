...
**secretValueRaw** | **string** |  | [optional] [default to undefined]
...
```typescript
import { EdfiAdminApiEdfiAdminV1InstanceApiClientProfileResponse } from '@edgraph-oss/platform-client';

const instance: EdfiAdminApiEdfiAdminV1InstanceApiClientProfileResponse = {
    tenantId,
    instanceId,
